...
public class CashierView implements Observer {
    private static final int H = 360; // Updated height to fit the Remove button
    private static final int W = 400; // Width of window pixels

    private static final String CHECK = "Check";
    private static final String BUY = "Buy";
    private static final String BOUGHT = "Bought/Pay";
    private static final String REMOVE = "Remove"; // New Remove button label
    ...
    public CashierView(RootPaneContainer rpc, MiddleFactory mf, int x, int y) {
        ...
        theBtRemove.setBounds(16, 25 + 60 * 3, 80, 40); // Remove Button
        theBtRemove.addActionListener(
            e -> {
                System.out.println("Remove button clicked in CashierView."); // Debug print
                cont.doRemove(theInput.getText());
            }
        );
        cp.add(theBtRemove); // Add Remove button to the canvas
